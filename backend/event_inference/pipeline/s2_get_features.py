...
def main():
    ...
    for dev_dir in os.listdir(in_dir):
        ...
        print(f"full dev dir 111: {full_dev_dir}")
        for act_dir in os.listdir(full_dev_dir):
            full_act_dir = os.path.join(full_dev_dir, act_dir)
            print(f"full act dir: {full_act_dir}")
            if '.DS_Store' in full_act_dir:
            ...
            if act_dir == 'unctrl' or act_dir == 'unctr'  or act_dir == 'idle':
                for dec_dir in os.listdir(full_act_dir):
                    ...
                    if '.DS_Store' in full_dec_dir:
                        print("found ds store full_dec_dir")
                        continue
                ...
                for event_dir in os.listdir(full_act_dir):
                    ...
                    print(f"full Event dir: {full_event_dir}")
                    if '.DS_Store' in full_event_dir:
                        print("found ds store full_dec_dir")
                        continue
